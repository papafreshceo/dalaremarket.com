                ...
                {['한눈에 보는 상품', '간편 발주시스템', '셀러 업무도구', '다양한 서비스'].map((tab, index) => (
                  <button
                    ...
                    style={{
                      ...
                      padding: '12px 16px',
                      background: (activeTab.main || 0) === index ? 'linear-gradient(135deg, #8b5cf6 0%, #3b82f6 100%)' : 'transparent',
                      color: (activeTab.main || 0) === index ? '#ffffff' : '#6c757d',
                      border: 'none',
                      borderRadius: '16px',
                      fontSize: '13px',
                      fontWeight: '500',
                    ...
                    onClick={() => setActiveTab({ ...activeTab, main: index })}
                  >
                    {tab}
                  </button>
                ))}
