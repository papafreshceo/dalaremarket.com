        ...
        {settingsCategories.map((category, categoryIndex) => (
          <div key={categoryIndex} className="bg-surface border border-border rounded-xl overflow-hidden">
            ...
            <div className="bg-primary px-4 py-3">
              <h2 className="text-sm font-bold text-primary-foreground">{category.category}</h2>
            </div>
              ...
              {category.cards.map((card) => {
                ...
                return (
                  ...
                  >
                    {/* 배지 */}
                    {card.badge && (
                      <span className="absolute top-2 right-2 px-1.5 py-0.5 bg-accent text-accent-foreground text-[10px] font-bold rounded">
                        {card.badge}
                      </span>
                    )}
