...
export default function RegisterOptionProductPage() {
  ...
  const [optionData, setOptionData] = useState<any>({
    ...
    naver_paid_shipping_price: '0',
    naver_free_shipping_price: '0',
    coupang_paid_shipping_price: '0',
    coupang_free_shipping_price: '0',
    supplier_id: '',
    shipping_vendor_id: '',
    invoice_entity: '',
    vendor_id: '',
  ...
  const fetchData = async () => {
    ...
    const { data: vendorData } = await supabase
      .from('partners')
      .select('*')
      .eq('partner_category', '벤더사')
      .eq('is_active', true)

    const { data: supplierData } = await supabase
      .from('partners')
      .select('*')
      .eq('partner_category', '공급자')
      .eq('is_active', true)
  ...
  const handleSave = async () => {
    try {
      if (selectedMaterials.length === 0) {
        showToast('최소 1개 이상의 원물을 선택해주세요.', 'warning')
        return
      }

      if (!optionData.option_name) {
        showToast('옵션명을 입력해주세요.', 'warning')
        return
      }
      ...
      const { data: newProduct, error: productError } = await supabase
        ...
        .insert([{
          ...optionData,
          option_code: optionData.option_code || `OPT${Date.now()}`,
          standard_quantity: parseFloat(optionData.standard_quantity) || null,
          ...
          raw_material_cost: parseFloat(optionData.raw_material_cost) || 0,
          packaging_box_price: parseFloat(optionData.packaging_box_price) || 0,
          pack_price: parseFloat(optionData.pack_price) || 0,
          bag_vinyl_price: parseFloat(optionData.bag_vinyl_price) || 0,
          cushioning_price: parseFloat(optionData.cushioning_price) || 0,
          sticker_price: parseFloat(optionData.sticker_price) || 0,
          ice_pack_price: parseFloat(optionData.ice_pack_price) || 0,
          other_material_price: parseFloat(optionData.other_material_price) || 0,
          labor_cost: parseFloat(optionData.labor_cost) || 0,
          total_cost: parseFloat(optionData.total_cost) || 0,
          seller_supply_price: parseFloat(optionData.seller_supply_price) || 0,
          seller_margin_rate: parseFloat(optionData.seller_margin_rate) || 0,
          naver_paid_shipping_price: parseFloat(optionData.naver_paid_shipping_price) || 0,
          naver_free_shipping_price: parseFloat(optionData.naver_free_shipping_price) || 0,
          coupang_paid_shipping_price: parseFloat(optionData.coupang_paid_shipping_price) || 0,
          coupang_free_shipping_price: parseFloat(optionData.coupang_free_shipping_price) || 0,
          shipping_fee: parseFloat(optionData.shipping_fee) || 0,
          shipping_additional_quantity: parseFloat(optionData.shipping_additional_quantity) || 0,
          misc_cost: parseFloat(optionData.misc_cost) || 0
        }])
        .select()
        .single()
      ...
      showToast('옵션상품이 등록되었습니다.', 'success')
      router.push('/admin/products/option-products')
    } catch (error) {
      console.error('Error saving option product:', error)
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {/* 2. 옵션상품 작성 테이블 */}
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <h2 className="text-[16px] font-semibold text-gray-900 dark:text-white mb-4">
            2. 옵션상품 정보 입력
          </h2>
            ...
            <table className="w-full text-[11px] border-collapse">
              <thead className="bg-gray-100 dark:bg-gray-700">
                <tr>
                  ...
                  <th className="border px-2 py-2 font-semibold min-w-[100px]">시즌피크</th>
              ...
              <tbody>
                <tr>
                  <td className="border px-1 py-1">
                    <input
                      type="text"
                      value={optionData.option_code}
                      onChange={(e) => setOptionData({ ...optionData, option_code: e.target.value })}
                  ...
                  <td className="border px-1 py-1">
                    <input
                      ...
                      onChange={(e) => setOptionData({ ...optionData, option_name: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                      placeholder="필수"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="text"
                      value={optionData.item_name}
                      onChange={(e) => setOptionData({ ...optionData, item_name: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="text"
                      value={optionData.middle_category}
                      onChange={(e) => setOptionData({ ...optionData, middle_category: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="text"
                      value={optionData.spec1}
                      onChange={(e) => setOptionData({ ...optionData, spec1: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="text"
                      value={optionData.spec2}
                      onChange={(e) => setOptionData({ ...optionData, spec2: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="text"
                      value={optionData.spec3}
                      onChange={(e) => setOptionData({ ...optionData, spec3: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.standard_quantity}
                      onChange={(e) => setOptionData({ ...optionData, standard_quantity: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="text"
                      value={optionData.standard_unit}
                      onChange={(e) => setOptionData({ ...optionData, standard_unit: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  {/* 가격 필드들 */}
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.raw_material_cost}
                      onChange={(e) => setOptionData({ ...optionData, raw_material_cost: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.packaging_box_price}
                      onChange={(e) => setOptionData({ ...optionData, packaging_box_price: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.pack_price}
                      onChange={(e) => setOptionData({ ...optionData, pack_price: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.bag_vinyl_price}
                      onChange={(e) => setOptionData({ ...optionData, bag_vinyl_price: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.cushioning_price}
                      onChange={(e) => setOptionData({ ...optionData, cushioning_price: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.sticker_price}
                      onChange={(e) => setOptionData({ ...optionData, sticker_price: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.ice_pack_price}
                      onChange={(e) => setOptionData({ ...optionData, ice_pack_price: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.other_material_price}
                      onChange={(e) => setOptionData({ ...optionData, other_material_price: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.labor_cost}
                      onChange={(e) => setOptionData({ ...optionData, labor_cost: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.seller_supply_price}
                      onChange={(e) => setOptionData({ ...optionData, seller_supply_price: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.seller_margin_rate}
                      onChange={(e) => setOptionData({ ...optionData, seller_margin_rate: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="number"
                      value={optionData.shipping_fee}
                      onChange={(e) => setOptionData({ ...optionData, shipping_fee: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  {/* 거래처 */}
                  <td className="border px-1 py-1">
                    <select
                      value={optionData.supplier_id}
                      onChange={(e) => setOptionData({ ...optionData, supplier_id: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    >
                  ...
                  <td className="border px-1 py-1">
                    <select
                      value={optionData.shipping_vendor_id}
                      onChange={(e) => setOptionData({ ...optionData, shipping_vendor_id: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    >
                      <option value="">선택</option>
                  ...
                  <td className="border px-1 py-1">
                    <select
                      value={optionData.invoice_entity}
                      onChange={(e) => setOptionData({ ...optionData, invoice_entity: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    >
                      <option value="">선택</option>
                  ...
                  <td className="border px-1 py-1">
                    <select
                      value={optionData.vendor_id}
                      onChange={(e) => setOptionData({ ...optionData, vendor_id: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    >
                      <option value="">선택</option>
                      {vendors.map(v => (
                  ...
                  <td className="border px-1 py-1">
                    <select
                      value={optionData.status}
                      onChange={(e) => setOptionData({ ...optionData, status: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    >
                      <option value="">선택</option>
                  ...
                  <td className="border px-1 py-1">
                    <input
                      type="date"
                      value={optionData.season_start_date}
                      onChange={(e) => setOptionData({ ...optionData, season_start_date: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="date"
                      value={optionData.season_peak_date}
                      onChange={(e) => setOptionData({ ...optionData, season_peak_date: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="date"
                      value={optionData.season_end_date}
                      onChange={(e) => setOptionData({ ...optionData, season_end_date: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  <td className="border px-1 py-1">
                    <input
                      type="text"
                      value={optionData.season}
                      onChange={(e) => setOptionData({ ...optionData, season: e.target.value })}
                      className="w-full px-1 py-1 border-0 bg-transparent text-[11px]"
                    />
                  </td>
                  {/* Y/N */}
                  <td className="border px-1 py-1 text-center">
                    <input
                      type="checkbox"
                      checked={optionData.is_seller_supply}
                      onChange={(e) => setOptionData({ ...optionData, is_seller_supply: e.target.checked })}
                      className="w-4 h-4"
                    />
                  </td>
                  <td className="border px-1 py-1 text-center">
                    <input
                      type="checkbox"
                      checked={optionData.is_best}
                      onChange={(e) => setOptionData({ ...optionData, is_best: e.target.checked })}
                      className="w-4 h-4"
                    />
                  </td>
                  <td className="border px-1 py-1 text-center">
                    <input
                      type="checkbox"
                      checked={optionData.is_recommended}
                      onChange={(e) => setOptionData({ ...optionData, is_recommended: e.target.checked })}
                      className="w-4 h-4"
                    />
                  </td>
                  <td className="border px-1 py-1 text-center">
                    <input
                      type="checkbox"
                      checked={optionData.has_detail_page}
                      onChange={(e) => setOptionData({ ...optionData, has_detail_page: e.target.checked })}
                      className="w-4 h-4"
                    />
                  </td>
                  <td className="border px-1 py-1 text-center">
                    <input
                      type="checkbox"
                      checked={optionData.has_images}
                      onChange={(e) => setOptionData({ ...optionData, has_images: e.target.checked })}
                      className="w-4 h-4"
                    />
                  </td>
                </tr>
