    ...
    <QueryClientProvider client={queryClient}>
      ...
      <header className="h-16 bg-surface border-b border-border shadow-sm z-50">
        <div className="h-full px-4 lg:px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* 알림 아이콘 */}
            <button className="relative p-2 rounded-lg hover:bg-surface-hover transition-colors group">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className={`
          ...
          w-44 h-full bg-surface border-r border-border
          transition-transform duration-200 ease-in-out z-40 shadow-sm
              ...
              {menuItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {active && (
                      <div className="ml-auto w-1 h-8 bg-gradient-to-b from-primary to-primary rounded-full" />
                    )}
                  </Link>
                )
              })}
