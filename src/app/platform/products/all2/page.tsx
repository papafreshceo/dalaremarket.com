      ...
      <div className="flex" style={{ border: '3px solid red' }}>
        ...
        {loading ? (
          ...
          <div className="flex gap-6">
                  ...
                  {groupedData.map(([itemName, groupProducts]) => {
                    ...
                    return (
                      ...
                      >
                        {/* 그룹 헤더 */}
                        <div
                          className={`px-4 py-1.5 transition-colors cursor-pointer overflow-visible relative ${
            ...
            {/* 칼럼2: 선택된 품목의 옵션상품 표시 */}
            <div className="flex-[0.85] sticky top-[105px] md:top-[140px] h-[calc(100vh-105px)] md:h-[calc(100vh-140px)] overflow-y-auto self-start" style={{ border: '3px solid yellow', backgroundColor: 'rgba(255, 255, 0, 0.05)' }}>
              {(() => {
                // 선택된 품목 찾기
                          ...
                          <div className="grid items-center gap-2 px-2 py-1.5" style={{ gridTemplateColumns: '40px minmax(150px, 1fr) 70px 70px 70px 90px 70px 100px' }}>
                            ...
                            <div className="flex items-center justify-end gap-2">
                              {(() => {
                                ...
                                return statusInfo ? (
                                  <span
                                    className="px-2 py-0.5 text-[10px] font-medium rounded-full text-white whitespace-nowrap"
            ...
            {/* 칼럼3: 새로운 칼럼 */}
            <div className="flex-[0.5] sticky top-[105px] md:top-[140px] h-[calc(100vh-105px)] md:h-[calc(100vh-140px)] overflow-y-auto self-start" style={{ border: '3px solid lime', backgroundColor: 'rgba(0, 255, 0, 0.05)' }}>
              <div className="p-4">
