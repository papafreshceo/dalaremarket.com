...
export const metadata = {
  title: '조직 관리 | 달래마켓',
  description: '조직 멤버 및 설정 관리 - 회원사의 다수 담당자를 지원하는 조직 시스템',
}
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
        <h4 className="font-semibold mb-2">조직 시스템 안내</h4>
        <ul className="text-sm text-gray-600 space-y-1">
          <li>• 같은 조직의 모든 멤버는 주문, 발주서 등의 데이터를 공유합니다</li>
          <li>• 소유자와 관리자는 멤버를 초대하고 관리할 수 있습니다</li>
          <li>• 각 멤버별로 세부 권한을 설정할 수 있습니다</li>
          <li>• 캐시와 크레딧은 조직 단위로 관리됩니다</li>
          <li>
            • 멤버가 등록한 주문은 자동으로 조직에 연결되어 모든 멤버가 조회 가능합니다
          </li>
        </ul>
      </div>
    </div>
