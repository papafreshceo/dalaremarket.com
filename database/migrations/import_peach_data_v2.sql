...
('hp4k12', '딱딱이(12과)', '농산물', '과일', '복숭아', '복숭아', '딱딱이', '4kg', 20000, 4, '2025-08-24', '여름', '2025-06-20', '2025-07-15', '2025-08-25', '공급중', (SELECT id FROM partners WHERE code = 'SUP0100')),
('hp4k14', '딱딱이(14과)', '농산물', '과일', '복숭아', '복숭아', '딱딱이', '4kg', 18000, 4, '2025-08-24', '여름', '2025-06-20', '2025-07-15', '2025-08-25', '공급중', (SELECT id FROM partners WHERE code = 'SUP0100')),
('hp4k16', '딱딱이(16과)', '농산물', '과일', '복숭아', '복숭아', '딱딱이', '4kg', 16000, 4, '2025-08-24', '여름', '2025-06-20', '2025-07-15', '2025-08-25', '공급중', (SELECT id FROM partners WHERE code = 'SUP0100')),
('hp4k18', '딱딱이(18과)', '농산물', '과일', '복숭아', '복숭아', '딱딱이', '4kg', 15000, 4, '2025-08-24', '여름', '2025-06-20', '2025-07-15', '2025-08-25', '공급중', (SELECT id FROM partners WHERE code = 'SUP0100')),
('hp4k20', '딱딱이(20과)', '농산물', '과일', '복숭아', '복숭아', '딱딱이', '4kg', 14500, 4, '2025-08-24', '여름', '2025-06-20', '2025-07-15', '2025-08-25', '공급중', (SELECT id FROM partners WHERE code = 'SUP0100')),
('hp4k22', '딱딱이(22과)', '농산물', '과일', '복숭아', '복숭아', '딱딱이', '4kg', 13000, 4, '2025-08-24', '여름', '2025-06-20', '2025-07-15', '2025-08-25', '공급중', (SELECT id FROM partners WHERE code = 'SUP0100')),
('hp4k24', '딱딱이(24과)', '농산물', '과일', '복숭아', '복숭아', '딱딱이', '4kg', 12000, 4, '2025-08-24', '여름', '2025-06-20', '2025-07-15', '2025-08-25', '공급중', (SELECT id FROM partners WHERE code = 'SUP0100'))
...
('hp4k22-013', '딱딱이1.3kg (8과)', '복숭아', '딱딱이', '1.3kg', '소과', '8과',
 ...
 3000, 0, '시즌종료', '여름', '2025-06-20', '2025-07-15', '2025-08-25',
...
('hp4k14-02', '딱딱이2kg (7과)', '복숭아', '딱딱이', '2kg', '대과', '7과',
 ...
 3000, 0, '공급중', '여름', '2025-06-20', '2025-07-15', '2025-08-25',
