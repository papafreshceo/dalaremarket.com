...
async function applyMigration() {
  try {
    console.log('📝 마이그레이션 시작: users 테이블에 tier 칼럼 추가...\n');

    // 1. seller_rankings에서 최신 tier 가져오기
    console.log('1️⃣ seller_rankings에서 tier 조회 중...');
    ...
    // 2. users 테이블 업데이트
    console.log('2️⃣ users 테이블에 tier 업데이트 중...');
    let updateCount = 0;
    let errorCount = 0;
