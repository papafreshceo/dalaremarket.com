...
-- UUID 확장 활성화 (Supabase는 기본 활성화되어 있지만 안전하게 확인)
...
CREATE INDEX IF NOT EXISTS idx_permissions_page_path ON permissions(page_path);
CREATE INDEX IF NOT EXISTS idx_permissions_role_page ON permissions(role, page_path);
